...
export default function ThemeToggle({ className = '' }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`glass-press flex min-h-11 min-w-11 items-center justify-center rounded-xl border border-[var(--line)] bg-[var(--surface)] text-mut hover:text-mint ${className}`}
    >
