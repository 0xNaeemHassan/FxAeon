...
export default function NotFound() {
  return (
    <main className="app-shell mx-auto flex min-h-[100dvh] w-full max-w-[430px] flex-col items-center justify-center px-6 py-10 text-center">
      ...
      <Link href="/portfolio" className="button button-primary glass-press mt-6 flex min-h-12 w-full max-w-[280px] items-center justify-center gap-2 rounded-lg px-4 py-3 text-[14px] font-semibold">
