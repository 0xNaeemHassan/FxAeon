...
const ko: Messages = {
  ...
  'portfolio.valueUnavailable': '실시간 평가액을 사용할 수 없습니다',
  'portfolio.pnlUnrealized': '미실현 손익',
  'portfolio.tabPositions': '포지션',
  'portfolio.tabFxusd': 'fxUSD',
  'portfolio.fxusdEmptyTitle': '아직 fxUSD 예치가 없습니다',
  'portfolio.fxusdEmptyBody': '봇에서 /save 로 fxUSD를 안정화 풀(fxSAVE)에 예치하면 수익을 얻을 수 있습니다 — 포지션이 여기에 표시되고 총 가치에 반영됩니다.',
  'portfolio.savingsTitle': 'fxUSD 안정화 풀',
  'portfolio.savingsShares': '{shares} 셰어',
  'portfolio.savingsRedeemReady': '청구 가능 — /claim 실행',
  'portfolio.savingsRedeemPending': '출금 대기 중',
  'portfolio.savingsValuePending': '가치 업데이트 중',
  'portfolio.savingsIncomplete': '지금은 예치 내역을 불러오지 못했습니다 — 새로고침하여 다시 시도하세요.',
  'portfolio.size': '크기',
  'portfolio.newPosition': '새 포지션',
