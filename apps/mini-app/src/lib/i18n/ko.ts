...
const ko: Messages = {
  ...
  'trade.review.title': '견적 검토',
  'trade.review.heading': '{side} 진입 — {market} {lev}x',
  'trade.review.youPay': '지불',
  'trade.review.youGet': '포지션 규모',
  'trade.review.minReceived': '최소 수령',
  'trade.review.leverageNote': '약 {lev}x 레버리지',
  'trade.review.entryPrice': '진입 가격',
  'trade.review.positionSize': '포지션 규모',
  'trade.review.borrowed': '차입금',
  'trade.review.slippage': '슬리피지 허용치',
  'trade.review.mev': 'MEV 보호',
  'trade.review.networkFee': '네트워크 수수료',
  'trade.review.gasMarket': '마켓',
  'trade.review.confirmSign': '확인 및 서명',
  'trade.review.quoting': '실시간 견적 가져오는 중…',
  'trade.review.refresh': '견적 새로고침',
  'trade.review.on': '켜짐',
  'trade.review.off': '꺼짐',
  'trade.review.honestNote': '견적·가스·슬리피지는 온체인에서 실시간으로 읽습니다. 확인하기 전까지 아무것도 전송되지 않습니다.',
  'trade.gas.title': '네트워크 수수료',
  'trade.gas.subtitle': 'EIP-1559 • 이더리움 메인넷',
  'trade.gas.maxBaseFee': '최대 기본 수수료',
  'trade.gas.priorityFee': '우선 수수료',
  'trade.gas.gasLimit': '가스 한도',
  'trade.gas.maxCost': '최대 비용',
  'trade.gas.speedTitle': '거래 속도',
  'trade.gas.tier.slow': '느림',
  'trade.gas.tier.market': '마켓',
  'trade.gas.tier.fast': '빠름',
  'trade.gas.tierNote': '최근 블록에서 가져온 실제 느림/마켓/빠름 우선 수수료. 서버가 다시 계산해 선택한 등급으로 브로드캐스트합니다.',
  'trade.exec.signing': '포지션 여는 중…',
  'trade.exec.signingNote': '시뮬레이션·서명·브로드캐스트 중입니다. 닫지 마세요.',
  'trade.result.opened': '포지션 진입 완료',
  'trade.result.summary': '{market} {lev}x • {amount} {token} 투입',
  'trade.result.transaction': '트랜잭션',
  'trade.result.status': '상태',
  'trade.result.block': '블록',
  'trade.result.gasPaid': '지불한 가스',
  'trade.result.confirmations': '확인 수',
  'trade.result.confirmed': '확인됨',
  'trade.result.submitted': '제출됨',
  'trade.result.broadcast': '브로드캐스트됨',
  'trade.result.deduped': '이미 제출됨 (중복 없음)',
  'trade.result.viewEtherscan': 'Etherscan에서 보기',
  'trade.result.done': '완료',
  'trade.result.failedTitle': '진입 실패',
  'trade.result.tryAgain': '다시 시도',
  'trade.result.enableTrading': '봇 거래 활성화',
  'trade.result.enableNote': '설정에서 세션 서명자를 부여한 후 다시 시도하세요.',
