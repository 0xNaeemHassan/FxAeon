...
const es: Messages = {
  ...
  'portfolio.fxusdEmptyTitle': 'Sin posiciones en fxUSD',
  'portfolio.fxusdEmptyBody': 'El seguimiento del fxUSD Stability Pool llegará pronto. Tus posiciones apalancadas aparecen en Posiciones.',
