...
const ru: Messages = {
  ...
  'portfolio.fxusdEmptyTitle': 'Пока нет сбережений в fxUSD',
  'portfolio.fxusdEmptyBody': 'Внесите fxUSD в пул стабильности (fxSAVE) командой /save в боте, чтобы получать доход — позиция появится здесь и войдёт в общую стоимость.',
  'portfolio.savingsTitle': 'Пул стабильности fxUSD',
  'portfolio.savingsShares': '{shares} долей',
  'portfolio.savingsRedeemReady': 'Готово к получению — выполните /claim',
  'portfolio.savingsRedeemPending': 'Вывод в период ожидания',
  'portfolio.savingsValuePending': 'Обновление стоимости',
  'portfolio.savingsIncomplete': 'Не удалось загрузить сбережения — обновите, чтобы повторить.',
