...
const ru: Messages = {
  ...
  'splash.tagline':
    'Торгуйте, занимайте, сберегайте, переводите между сетями и управляйте всеми позициями f(x) Protocol в одном некастодиальном приложении Telegram.',
  ...
  'portfolio.qaTradeHint': 'До 7x для лонгов',
  ...
  'trade.review.title': 'Проверка котировки',
  'trade.review.heading': 'Открыть {side} — {market} {lev}x',
  'trade.review.youPay': 'Вы платите',
  'trade.review.youGet': 'Размер позиции',
  'trade.review.minReceived': 'Минимум к получению',
  'trade.review.leverageNote': '~{lev}x плечо',
  'trade.review.entryPrice': 'Цена входа',
  'trade.review.positionSize': 'Размер позиции',
  'trade.review.borrowed': 'Заёмные средства',
  'trade.review.slippage': 'Допустимое проскальзывание',
  'trade.review.mev': 'MEV-защита',
  'trade.review.networkFee': 'Комиссия сети',
  'trade.review.gasMarket': 'Рыночная',
  'trade.review.confirmSign': 'Подтвердить и подписать',
  'trade.review.quoting': 'Получаем актуальную котировку…',
  'trade.review.refresh': 'Обновить котировку',
  'trade.review.on': 'ВКЛ',
  'trade.review.off': 'ВЫКЛ',
  'trade.review.honestNote': 'Котировка, газ и проскальзывание считываются в реальном времени on-chain. Ничего не отправляется до подтверждения.',
  'trade.gas.title': 'Комиссия сети',
  'trade.gas.subtitle': 'EIP-1559 • Ethereum mainnet',
  'trade.gas.maxBaseFee': 'Макс. базовая комиссия',
  'trade.gas.priorityFee': 'Приоритетная комиссия',
  'trade.gas.gasLimit': 'Лимит газа',
  'trade.gas.maxCost': 'Макс. стоимость',
  'trade.gas.speedTitle': 'Скорость транзакции',
  'trade.gas.tier.slow': 'Медленно',
  'trade.gas.tier.market': 'Рыночная',
  'trade.gas.tier.fast': 'Быстро',
  'trade.gas.tierNote': 'Реальные приоритетные чаевые Медленно/Рыночная/Быстро из последних блоков. Сервер пересчитывает и отправляет выбранный вами уровень.',
  'trade.exec.signing': 'Открываем позицию…',
  'trade.exec.signingNote': 'Симуляция, подпись и трансляция. Не закрывайте.',
  'trade.result.opened': 'Позиция открыта',
  'trade.result.summary': '{market} {lev}x • внесено {amount} {token}',
  'trade.result.transaction': 'Транзакция',
  'trade.result.status': 'Статус',
  'trade.result.block': 'Блок',
  'trade.result.gasPaid': 'Оплачено за газ',
  'trade.result.confirmations': 'Подтверждения',
  'trade.result.confirmed': 'Подтверждена',
  'trade.result.submitted': 'Отправлена',
  'trade.result.broadcast': 'Транслирована',
  'trade.result.deduped': 'Уже отправлено (дубликат не создан)',
  'trade.result.viewEtherscan': 'Открыть в Etherscan',
  'trade.result.done': 'Готово',
  'trade.result.failedTitle': 'Не удалось открыть',
  'trade.result.tryAgain': 'Повторить',
  'trade.result.enableTrading': 'Включить торговлю бота',
  'trade.result.enableNote': 'Предоставьте сессионного подписанта в Настройках и повторите.',
  ...
  'policy.rule3Body':
    'До проверки сервер формирует точный план, проверяет его политикой и симулирует. Конвертации позиций должны точно совпадать с закреплённой таблицей маршрутов v1 SDK f(x).',
  'policy.rule4Title': 'Двухминутная проверка с привязкой к кошельку',
  'policy.rule4Body':
    'Mini App фиксирует этот точный план на 2 минуты. Подтверждение забирает одноразовый билет; повтор может вернуть только ту же идемпотентную запись транзакции.',
  'policy.footer':
    'В «Активности» сохраняются хеш и статус каждого шага: ожидание, частичное исполнение, отмена, откат или подтверждение. Управляйте доступом к подписи в Настройки → Кошелёк.',
