...
start-welcome-new =
    ...
    🔐 Некастодиальный — ваш кошелёк политикой ограничен только контрактами f(x)
...
start-tap-button = 👇 Нажмите кнопку ниже, чтобы создать кошелёк.
start-create-wallet = 🔐 Создать кошелёк
start-welcome-back =
...
help-body =
    ...
    🤖 Автоматизация
      /auto — Создание/управление правилами
