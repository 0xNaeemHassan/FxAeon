...
start-welcome-new =
    🚀 Добро пожаловать в FxAeon
    
    Самый продвинутый интерфейс для f(x) Protocol — позиции с плечом и автоматизация доходности, всё прямо в Telegram.
...
help-body =
    ...
    🤖 Автоматизация
      ...
      /refer — Ссылка-приглашение + связанные аккаунты
