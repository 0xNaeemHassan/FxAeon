...
start-welcome-new =
    ...
    La interfaz más avanzada para f(x) Protocol — posiciones apalancadas y automatización de rendimiento, todo desde Telegram.
...
help-body =
    ...
    🤖 Automatización
      ...
      /refer — Tu enlace de invitación + cuentas vinculadas
